  ...
  <body>
    ...
    <header id="header" stats="false">
      <div class="d-flex flex-column">
        <div class="profile">
          <img src="images/RapmaFM Header.png " alt="" class="img-fluid rounded-circle">
        ...
        <nav id="navbar" class="nav-menu navbar">
          <ul>
            ...
            <li><a href="#program" class="nav-link scrollto"><i class="bx bx-microphone" title="Program"></i>
          ...
          <div class="profile">
            <div class="social-links mt-3 text-center">
              ...
              <a href="https://liff.line.me/1645278921-kWRPP32q?accountId=vxw1531h&openerPlatform=webview&openerKey=webview%3AunifiedSearch" target="_blank" class="line" title="Line">
                <i><img src="images/Line.svg" height="20px" weight="20px"></i></a>
      ...
      <div class="container">
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="images/GMPA.png" class="img-fluid" alt="GMPA" data-aos="fade-up">
              </div>
              <div class="carousel-item">
                <img src="images/Umum.png" class="img-fluid" alt="Divisi Umum" data-aos="fade-up">
              </div>
              <div class="carousel-item">
                <img src="images/Kepenyiaran.png" class="img-fluid" alt="Divisi Kepenyiaran" data-aos="fade-up">
              </div>
              <div class="carousel-item">
                <img src="images/Marketing.png" class="img-fluid" alt="Divisi Marketing" data-aos="fade-up">
              </div>
              <div class="carousel-item">
                <img src="images/Personalia.png" class="img-fluid" alt="Divisi Personalia" data-aos="fade-up">
              </div>
            </div>
        ...
        <div class="row">
          <div class="col section-bottom-button" data-aos="fade-up">
            <img src="images/Crew.png" class="img-fluid" alt="Crew">
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/BasoSapi.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/BasoSapi.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/11N1.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/11N1.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/Rapmanesia.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/Rapmanesia.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/TGV.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/TGV.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <!-- <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/THR.jpeg" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/THR.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/KhasanahPetang.jpg" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/KhasanahPetang.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/MusicBox.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/MusicBox.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/Afterday.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/Afterday.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="images/TOP15.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/TOP15.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item">
            <div class="portfolio-wrap">
              <img src="images/Rapmatalks.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/Rapmatalks.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/MovieScreen.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/MovieScreen.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/KingNQueen.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/KingNQueen.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/Indiezone.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/Indiezone.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/Teksas.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/Teksas.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/Merinding.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/Merinding.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/K-Arena.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/K-Arena.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/SudutKampus.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/SudutKampus.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/NoSatnight.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/NoSatnight.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="images/ClassicNight.png" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="images/ClassicNight.png" data-gallery="portfolioGallery" class="portfolio-lightbox"><i class="bx bx-zoom-in" title="Zoom In"></i></a>
        ...
        <div class="row" data-aos="fade-in">
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="row">
              ...
              <iframe
							src="https://open.spotify.com/embed/playlist/0rj1HLftduTk5t2OC6t0XD?si=GgqgR4zfSZGfZj3mnjEd3g"
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="row">
              ...
              <iframe
							src="https://open.spotify.com/embed/playlist/48GHvGhwDZFBL6X88c20Zd?si=IX3o5iOWTiOxA3xqw8lYGg"
              width="100%" height="500" frameborder="0"></iframe>
          </div>
        </div>
      </div>
      ...
      <div class="row g-4 g-md-6">
        ...
        <div class="col-6 col-md-6">
          <div class="card-body">
            ...
            <center>
              <img class="card-img-top" src="images/Rapmaday7.png" style="width:100%">
            </center>
              <div class="card-body">
              <center>
        ...
        <div class="col-6 col-md-6">
          <div class="card-body">
            ...
            <center>
              <img class="card-img-top" src="images/Rapmafest8.png" style="width:100%">
            </center>
            <div class="card-body">
              <center>
      ...
      <div class="row g-2 g-md-4">
        ...
        <div class="col-6 col-md-4">
          <div class="card">
            ...
            <center>
              <img class="card-img-top" src="images/Lomba 2019.jpg" style="width:75%">
            </center>
            <div class="card-body">
              <center>
        ...
        <div class="col-6 col-md-4">
          <div class="card">
            ...
            <center>
              <img class="card-img-top" src="images/Lomba 2020.jpg" style="width:75%">
            </center>
            <div class="card-body">
              <center>
        ...
        <div class="col-6 col-md-4">
          <div class="card">
            ...
            <center>
              <img class="card-img-top" src="images/Lomba 2021-1.jpg" style="width:75%">
            </center>
            <div class="card-body">
              <center>
        ...
        <div class="col-6 col-md-4">
          <div class="card">
            ...
            <center>
              <img class="card-img-top" src="images/Lomba 2021-2.jpg" style="width:75%">
            </center>
            <div class="card-body">
              <center>
        ...
        <div class="col-6 col-md-4">
          <div class="card">
            ...
            <center>
              <img class="card-img-top" src="images/Lomba 2021-3.jpg" style="width:75%">
            </center>
            <div class="card-body">
              <center>
                <a href="https://www.instagram.com/p/CPNZVp_pxEZ/?utm_source=ig_web_copy_link" target="_blank" class="btn btn-success">See Details</a>
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="row">
              ...
              <p style="text-align: justify;">RAPMAFEST #8 yang bertajuk "NOSTALGIC FUTURE TO CREATE MIRACLE", RAPMAFEST #8 ini memiliki 
                ...
                RAPMAFEST #8 yang<a href="http://rapmafm.ukm.ums.ac.id/2021/10/keseruan-rapmafest-8-nostalgic-future.html" 
                title="Selengkapnya" style="color:#008C52" target="_blank"> ...read more</a></p>
            </div>
          </div>
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="row">
              ...
              <p style="text-align: justify;">Kali ini kita akan menyapa CampusBrainers dengan event tahunan kita. 
                ...
                Rapmaday kali ini disiarkan langsung dari<a href="http://rapmafm.ukm.ums.ac.id/2021/04/rapmaday7-act-beyond-imagination.html" 
                title="Selengkapnya" style="color:#008C52" target="_blank"> ...read more</a></p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="row">
              ...
              <p style="text-align: justify;">Sarasehan Rapma FM tahun 2021 mengangkat tema Adventure 
                ...
                CampusBrainers Sarase<a href="http://rapmafm.ukm.ums.ac.id/2021/03/menyambung-silaturahmi-dengan.html" 
                title="Selengkapnya" style="color:#008C52" target="_blank"> ...read more</a></p>
            </div>
          </div>
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="row">
              ...
              <p style="text-align: justify;">CampusBrainers !! Kami bakalan berbagi cerita tentang keseruan virtual study broadcast di Geronimo FM. 
                ...
                <a href="http://rapmafm.ukm.ums.ac.id/2021/02/kunjungan-tanpa-pertemuan-rapma-fm-ke.html" 
                title="Selengkapnya" style="color:#008C52" target="_blank"> ...read more</a></p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="info">
              ...
              <div class="address">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.1722825033103!2d110.76873700406814!3d-7.556185825852349!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a145b44ab2e7b%3A0x907e13e28374d39b!2sRapma+FM!5e0!3m2!1sid!2sid!4v1547644067180"
    ...
    <footer id="footer">
      <div class="container">
        <div class="copyright">
          Copyright <a href="http://rapmafm.com:2082/" style="color:black;" target="_blank">
            &copy;</a> <strong><span>2021 Rapma FM</span></strong>
        </div>
      </div>
    </footer>
